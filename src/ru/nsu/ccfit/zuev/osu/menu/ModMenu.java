...
//        addButton(offset + offsetGrowth * 2, Config.getRES_HEIGHT() / 2 - button.getHeight() / 2, "selection-mod-nightcore", GameMod.MOD_NIGHTCORE);
        addButton(offset + offsetGrowth * 2, Config.getRES_HEIGHT() / 2 - button.getHeight() / 2, "selection-mod-hidden", GameMod.MOD_HIDDEN);
        addButton(offset + offsetGrowth * 3, Config.getRES_HEIGHT() / 2 - button.getHeight() / 2, "selection-mod-flashlight", GameMod.MOD_FLASHLIGHT);
...
//        addButton(offset + offsetGrowth * 2, Config.getRES_HEIGHT() / 2 + button.getHeight() * 2, "selection-mod-autoplay", GameMod.MOD_AUTO);
        addButton(offset, Config.getRES_HEIGHT() / 2 + button.getHeight() * 2, "selection-mod-scorev2", GameMod.MOD_SCOREV2);
        addButton(offset + offsetGrowth, Config.getRES_HEIGHT() / 2 + button.getHeight() * 2, "selection-mod-precise", GameMod.MOD_PRECISE);
            ...
            public boolean onAreaTouched(final TouchEvent pSceneTouchEvent,
                ...
                if (pSceneTouchEvent.isActionUp()) {
                    ...
                    for (ModButton btn : modButtons.values()) {
                        ...
                        if(btn.getMod() == GameMod.MOD_SCOREV2 ||
                            btn.getMod() == GameMod.MOD_NOFAIL) {
                            btn.setModEnabled(true);
                            switchMod(btn.getMod());
                        }
                    }
                    return true;
                }
